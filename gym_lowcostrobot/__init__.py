...
ASSETS_PATH = "/Users/michel_aractingi/code/gym-lowcostrobot/gym_lowcostrobot/assets/low_cost_robot_6dof"#os.path.join(os.path.dirname(__file__), "assets", "low_cost_robot_6dof")
